...
class _AssignmentPageState extends State<AssignmentPage> {
  ...
  Future<Map<String, dynamic>> fetchAssignmentDetails(String assignmentId) async {
    ...
    final url = Uri.parse("${ApiConstants.baseUrl}student/course/assignment-detail");
  ...
  Future<Map<String, dynamic>> fetchAssignmentResult(String assignmentId) async {
    ...
    final url = Uri.parse("${ApiConstants.baseUrl}student/course/assignment-result");
    final response = await http.post(
      url,
      headers: {
        'Authorization': 'Bearer $token',
              ...
              Row(
                ...
                children: [
                  Expanded(
                    ...
                    child: SizedBox(
                      height: 55.h, // Set height for View Details button
                      child: Stack(
                  ...
                  Expanded(
                    child: SizedBox(
                      height: 55.h, // Set height for See Result button
                      child: Stack(
                        alignment: Alignment.center,
                        children: [
                          CustomButton(
