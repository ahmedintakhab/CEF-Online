      ...
      child: Column(
        children: [
          ...
          CustomDropdown(
            ...
            items: const ["Instructor", "Organization"], // Dropdown options
          ...
          SizedBox(height: 20.h),
          customTextFormField(controller:professionController, hintText: "Professional Title",
            validator: (val){
              if (val!.isEmpty) return 'Enter the professional title';
              return null;
            },),
          SizedBox(height: 20.h),
          customTextFormField(controller:addressController, hintText: "Address",
            validator: (val){
          ...
          SizedBox(height: 20.h),
          customTextFormField(controller:bioController, hintText: "Bio",
            validator: (val){
              if (val!.isEmpty) return 'Enter the Bio';
              return null;
            },),
          SizedBox(height: 20.h),
          // Add the FileChoosenWidget here
          FileChoosenWidget(
            onFileSelected: (filePath) {
              setState(() {
                selectedFilePath = filePath;
                fileError = null; // Clear error when a file is selected
              });
            },
            errorText: fileError,
          ),
